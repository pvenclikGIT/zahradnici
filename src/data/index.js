...
export const defaultClients = [
  { id:1,  name:'Ing. Pavel Horák',       phone:'+420 605 111 222', email:'p.horak@email.cz',         address:'Ke Křížku 14, Praha-Šeberov',          city:'Praha-Šeberov',          notes:'Pozor na psa Rexe — volný v zahradě. Kód od branky: 4521. Preferuje dopoledne do 11:00.', tags:['pravidelný','vip'], status:'active', gardenSize:'velká',   joinDate:'2021-03-15', lat:49.9920, lng:14.5180 },
  { id:2,  name:'Správa objektů Říčany',  phone:'+420 323 600 100', email:'zahrada@so-ricany.cz',     address:'Říčanská 8, Říčany u Prahy',           city:'Říčany',                 notes:'Firemní areál 3200 m2. Fakturace na IČO 45123678. Vždy fakturovat do 25. v měsíci.', tags:['firemní','pravidelný'], status:'active', gardenSize:'velká', joinDate:'2021-01-10', lat:49.9918, lng:14.6553 },
  { id:3,  name:'Marie Procházková',      phone:'+420 608 555 666', email:'m.prochazkova@seznam.cz',  address:'Lipová alej 33, Průhonice',             city:'Průhonice',              notes:'Alergická na pyl — nosit rukavice. Ráda si popovídá u kávy.', tags:['pravidelný'], status:'active', gardenSize:'malá', joinDate:'2020-06-20', lat:49.9899, lng:14.5484 },
  { id:4,  name:'Tomáš Kratochvíl',       phone:'+420 601 777 888', email:'t.kratochvil@gmail.com',   address:'Větrná 5, Čestlice',                   city:'Čestlice',               notes:'Novostavba 2022, velká zahrada 800 m2. Zajímá se o zahradničení, rád se ptá.', tags:['nový','pravidelný'], status:'active', gardenSize:'velká', joinDate:'2023-02-01', lat:49.9997, lng:14.6003 },
  { id:5,  name:'Jana Bártová',           phone:'+420 604 999 000', email:'j.bartova@volny.cz',       address:'Slunečná 12, Jesenice u Prahy',        city:'Jesenice',               notes:'Klíče u sousedky p. Novákové č.p. 14. Branka se zamyká.', tags:['pravidelný'], status:'active', gardenSize:'střední', joinDate:'2022-04-10', lat:49.9599, lng:14.5199 },
  { id:6,  name:'Robert Šimánek',         phone:'+420 603 222 111', email:'r.simanek@podnikatel.cz',  address:'Jasanová 44, Velké Popovice',          city:'Velké Popovice',         notes:'Zahrada 1400 m2 se sadem. Precizní práce nutností — VIP klient. Vždy platí hotově na místě.', tags:['vip','pravidelný'], status:'active', gardenSize:'velká', joinDate:'2020-12-01', lat:49.9199, lng:14.6099 },
  { id:7,  name:'Hotel Průhonice',         phone:'+420 271 015 911', email:'zahrada@hotel-pruhonice.cz','address':'U Parku 6, Průhonice',             city:'Průhonice',              notes:'Hotelová zahrada u vstupu — reprezentativní vzhled je povinností. Přístup přes recepci.', tags:['firemní','vip'], status:'active', gardenSize:'velká', joinDate:'2021-04-20', lat:49.9912, lng:14.5472 },
  { id:8,  name:'Petr Novotný',           phone:'+420 606 444 555', email:'p.novotny@centrum.cz',     address:'Kaštanová 7, Říčany u Prahy',          city:'Říčany',                 notes:'Pensionista, doma téměř vždy. Preferuje páteční návštěvy. Čaj vždy připraven.', tags:['pravidelný'], status:'active', gardenSize:'střední', joinDate:'2022-08-30', lat:49.9911, lng:14.6559 },
  { id:9,  name:'Lucie Horáková',         phone:'+420 607 333 777', email:'l.horakova@email.cz',      address:'Nad Rybníkem 22, Sulice',              city:'Sulice',                 notes:'Mladá rodina, 3 malé děti — zahrada musí být bezpečná, bez chemie.', tags:['pravidelný'], status:'active', gardenSize:'střední', joinDate:'2023-05-12', lat:49.9729, lng:14.6010 },
  { id:10, name:'Ing. arch. Blaha',       phone:'+420 777 888 999', email:'blaha.arch@studio.cz',     address:'Příční 88, Popovičky',                 city:'Popovičky',              notes:'Architekt — vysoké nároky na estetiku. Každý detail musí být perfektní.', tags:['vip'], status:'active', gardenSize:'velká', joinDate:'2022-11-01', lat:49.9458, lng:14.6258 },
  { id:11, name:'Eva Součková',           phone:'+420 602 555 444', email:'e.souckova@email.cz',      address:'Polní 3, Zdiby',                       city:'Zdiby',                  notes:'Odjíždí každý pátek. Klíče pod rohožkou na zadní terase. Volné parkování na dvoře.', tags:['pravidelný'], status:'active', gardenSize:'střední', joinDate:'2023-09-15', lat:50.1799, lng:14.4799 },
  ...
  { id:13, name:'Martin Vlček',           phone:'+420 608 777 123', email:'m.vlcek@firma.cz',         address:'U Lesíka 5, Mukařov',                  city:'Mukařov',                notes:'Dřívější termíny preferuje — chodí do práce v 7:30. Pes Benny v ohradě.', tags:['pravidelný'], status:'active', gardenSize:'střední', joinDate:'2024-01-15', lat:49.9620, lng:14.7220 },
  { id:14, name:'Dagmar Kopecká',         phone:'+420 605 321 654', email:'d.kopecka@seznam.cz',      address:'Nová 18, Dobřejovice',                 city:'Dobřejovice',            notes:'Důchodkyně, ráda přihlíží. Nabídne vždy ovoce ze zahrady.', tags:['pravidelný'], status:'inactive', gardenSize:'malá', joinDate:'2021-07-20', lat:49.9720, lng:14.5720 },
]
