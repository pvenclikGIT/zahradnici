...
import { Plus, ClipboardList, Users, Receipt, Package, Camera } from 'lucide-react'
...
const fabActions = [
  ...
  { icon:Camera,        label:'Naskenovat účtenku', to:'/receipts', color:'bg-rose-500',  perm:'invoices' },
]
